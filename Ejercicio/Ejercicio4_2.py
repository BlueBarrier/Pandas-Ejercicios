...
with open("Ejercicio/encuesta_sports.csv",mode="w") as encu:
...
def encuesta():
    ...
    with open("Ejercicio/encuesta_sports.csv",mode="a") as encu:
        header=["Carnet","Estudiante","Carrera","Practica Favorita","Practica Gustaria"]
        writer=csv.DictWriter(encu,fieldnames=header,delimiter=",",lineterminator="\n")
...
def MostraEncuesta():
    try:
        with open("Ejercicio/encuesta_sports.csv",mode="r") as encuread:
